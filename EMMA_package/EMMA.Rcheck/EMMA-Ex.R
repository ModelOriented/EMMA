...
options(warn = 1)
base::assign(".ExTimings", "EMMA-Ex.timings", pos = 'CheckExEnv')
...
## Not run: 
##D   graph <- PipeOpmissForest$new() %>>% mlr3learners::LearnerClassifGlmnet$new()
...
## Not run: 
##D   graph <- PipeOpmissRanger$new() %>>% mlr3learners::LearnerClassifGlmnet$new()
##D   graph_learner <- GraphLearner$new(graph)
##D 
##D   # Task with NA
##D 
