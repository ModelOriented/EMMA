                                    ...
                                    initialize = function(id = "imput_mice_A",set_cor=0.5,m=5,maxit=5,random.seed=123,correlation=F
                                      ...
                                      .train_imputer=function(feature, type, context){
                                        imp_function <- function(data_to_impute){
                                          ...
                                          print(self$param_set$values$set_cor)
                                      ...
                                      .impute=function(feature, type, model, context){
                                        ...
                                        imp_function <- function(data_to_impute){
                                          ...
                                          if(nrow(data_to_impute)==1){
                                            ...
                                            data_train <- rbind(data_train,data_to_impute)

                                            data_to_impute <- mice.reuse(self$moodel,data_to_impute,maxit=self$param_set$maxit,printFlag = T)$`1`[nrow(data_train),]
                                          }else{
