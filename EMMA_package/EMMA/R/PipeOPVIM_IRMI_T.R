#' @title PipeOpVIM_IRMI_T
#' @name PipeOpVIM_IRMI_T
#'
#' @description
...
PipeOpVIM_IRMI_T <-  R6::R6Class("VIM_IRMI_imputation",lock_objects=FALSE,
                             ...
                             public = list(
                               initialize = function(id = "imput_VIM_IRMI",eps=5,maxit=100,step=FALSE,robust=FALSE,init.method='kNN',force=FALSE,col_0_1= FALSE,
                                 ...
                                 super$initialize(id,  param_vals = list( col_0_1=col_0_1,eps=eps,maxit=maxit,step=step,robust=robust,
