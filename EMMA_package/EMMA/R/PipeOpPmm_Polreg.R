PipeOpmice_A <- R6::R6Class("missMDA_MFAimputation",
  lock_objects = FALSE,
  ...
  public = list(
    initialize = function(id = "imput_missMDA_MFA", ncp = 2, random.seed = 123, maxiter = 998,
      ...
      super$initialize(id,
        whole_task_dependent = TRUE, param_vals = list(
    ...
    .train_imputer = function(feature, type, context) {
      ...
      imp_function <- function(data_to_impute) {
        ...
        data_imputed <- missMDA_MFA(data_to_impute, col_type, percent_of_missing,
