...
But the real advantage of using NADIA comes from integration with mlr3. Because of that, we can easily include advanced imputation techniques inside the machine learning models. For example:
